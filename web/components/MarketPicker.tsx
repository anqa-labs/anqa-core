...
/**
 * Solana's mark, drawn here rather than fetched.
 *
 * The icon set pinned on the CDN still ships an old SOL logo, so this one is
 * local — the venue settles on Solana and showing the wrong Solana logo is not
 * a detail worth outsourcing.
 */
function SolanaMark({ size }: { size: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 398 312" className="shrink-0">
      <defs>
        <linearGradient id="sol-mark" x1="360" y1="-37" x2="141" y2="383"
